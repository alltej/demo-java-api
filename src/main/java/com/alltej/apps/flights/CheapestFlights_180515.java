 ...
 * 5/15/2018
 */
public class CheapestFlights_180515 {
    ...
    @Test public void cheapest_flight_by_flight_id() {
        ...
        Map<String, Flight> cheapFlightsHash = flights.stream().collect( groupingBy( Flight::getFlightId,
                collectingAndThen( reducing( ( f1, f2 ) -> f1.getCost() > f2.getCost() ? f2 : f1 ), Optional::get ) ) );
